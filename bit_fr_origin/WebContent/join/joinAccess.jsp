...
<script type="text/javascript">
	function chk() {
		var ck1 = document.form.ck1.checked;
		var ck2 = document.form.ck2.checked;
		var num = 0;
...
<body>
	...
	<h2>JOIN</h2><hr>
	<form action="joinCheck.do" name="form" method="post">
			<table width="100%" height="650">
				<tr>
					<td width="100%" height="50%" align="center">
						<p align="left">
							<span style="padding-left: 160px"> BIT가구대여 약관동의</span>
...
- 협력회사로부터의 제공 
- 생성정보 수집 툴을 통한 수집
   </textarea> <br> <input type="checkbox" name="ck1"> 개인정보 수집 및 이용에
						동의합니다.
					</td>
				</tr>
				<tr>
...
- 협력회사로부터의 제공 
- 생성정보 수집 툴을 통한 수집
   </textarea> <br> <input type="checkbox" name="ck2"> 개인정보 수집 및 이용에
						동의합니다.
					</td>
				</tr>
				<tr>
